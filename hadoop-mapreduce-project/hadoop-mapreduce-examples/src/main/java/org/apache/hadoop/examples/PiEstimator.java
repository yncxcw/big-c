...
public class PiEstimator extends Configured implements Tool {
   ...
   * and then count points inside/outside of the inscribed circle of the square.
   */
  public static class PiMapper extends Mapper<LongWritable, LongWritable, BooleanWritable, LongWritable> {
   ...
   * Accumulate points inside/outside results from the mappers.
   */
  public static class PiReducer extends Reducer<BooleanWritable, LongWritable, WritableComparable<?>, Writable> {
