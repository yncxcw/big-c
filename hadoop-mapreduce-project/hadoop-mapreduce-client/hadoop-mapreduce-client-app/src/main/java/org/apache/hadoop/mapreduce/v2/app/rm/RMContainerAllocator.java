...
public class RMContainerAllocator extends RMContainerRequestor
 ...
 // private ReduceScheduler reduceScheduler = new DefaultReduceScheduler("ReduceScheduelr");
  ...
  protected void serviceStart() throws Exception {
	//this.reduceScheduler.serviceStart();  
  ...
  protected void serviceStop() throws Exception {
   ...
   // this.reduceScheduler.serviceStop();
  ...
  public void scheduleAllReduces() {
    for (ContainerRequest req : pendingReduces) {
      //reduceScheduler.selectHostForReduceRequest(req);	
  ...
  public void rampUpReduces(int rampUp) {
    ...
    for (int i = 0; i < rampUp; i++) {
      ...
      //reduceScheduler.selectHostForReduceRequest(request);
